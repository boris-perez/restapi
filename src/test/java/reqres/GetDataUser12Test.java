...
public class GetDataUser12Test {
    ...
    @Test
    public void getDataUser12() throws URISyntaxException, IOException, InterruptedException {
        ...
        String validationSchema = JsonSchemaValidator.validateJsonAgainstSchema(response.body(), "SingleUserSchema.json");
