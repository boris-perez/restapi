...
public class GetUnknownTest {
    ...
    @Test
    public void getUnknownUser() throws URISyntaxException, IOException, InterruptedException {
        ...
        String validationSchema = JsonSchemaValidator.validateJsonAgainstSchema(response.body(), "UnknownUserSchema.json");
